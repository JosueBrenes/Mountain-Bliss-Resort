      ...
      <div class="container">
        <div class="row">
          <div class="container mt-5">
            <h1 style="color: #333">Agregar Nueva Habitación</h1>
            <form action="insertar_habitacion.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tipo_habitacion" name="tipo_habitacion" class="form-control">
                </div>
                <div class="form-group">
                    <label for="precio_por_noche">Precio por Noche</label>
                    <input type="number" id="precio_por_noche" name="precio_por_noche" step="0.01" class="form-control">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn" style="background-color: #013e6a; color: white; margin-bottom: 2rem;">Agregar Habitación</button>
            </form>
          </div>
        </div>
      </div>
