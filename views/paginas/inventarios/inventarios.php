...
$stid = oci_parse($conn, 'BEGIN obtener_inventarios(:p_cursor); END;');
...
<head>
    ...
    <title>Inventarios - Mountain-Bliss-Resort</title>
...
<body>
    ...
    <div class="content">
        ...
        <section class="options_area">
            <div class="container">
                <h1 style="color: #333">Inventarios</h1>
                <a href="agregar_inventario.php" class="button">Agregar Nuevo Producto</a>
                <a href="funciones/generar_reporte_inventarios.php" class="button">Filtrar Producto por cantidad</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th>ID</th>
                    ...
                    <tbody>
                        <?php while (($row = oci_fetch_assoc($cursor)) !== false): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['NOMBREPRODUCTO'], ENT_QUOTES); ?></td>
