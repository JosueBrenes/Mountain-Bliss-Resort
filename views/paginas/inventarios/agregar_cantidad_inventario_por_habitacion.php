...
<head>
    ...
    <title>Cantidad Inventario por Habitación - Mountain-Bliss-Resort</title>
      ...
      <div class="container">
        <div class="row">
          <div class="container mt-5">
            <h1 style="color: #333">Agregar Cantidad de Inventario por Habitación</h1>
            <form action="insertar_cantidad_inventario.php" method="POST">
                ...
                <button type="submit" class="btn" style="background-color: #013e6a; color: white; margin-bottom: 2rem;">Agregar Cantidad</button>
            </form>
          </div>
        </div>
      </div>
