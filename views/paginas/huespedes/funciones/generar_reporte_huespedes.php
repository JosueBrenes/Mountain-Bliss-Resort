...
// Variable para almacenar los huéspedes
$huespedes = [];

// Verificar si se ha enviado una solicitud para obtener la lista de huéspedes
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Preparar la consulta para llamar a la función
    $query = 'BEGIN :cursor := LISTA_HUESPEDES_ORDENADOS; END;';
...
<head>
    ...
    <title>Reporte de Huéspedes - Mountain-Bliss-Resort</title>
    ...
    <div class="content">
        ...
        <section class="options_area">
            <div class="container">
                <div class="row">
                    <div class="container">
                        <h1 style="color: #333">Reporte de Huéspedes</h1>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($huespedes as $huesped): ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($huesped['HUESPEDID'], ENT_QUOTES); ?></td>
                                                <td><?php echo htmlspecialchars($huesped['NOMBRE'], ENT_QUOTES); ?></td>
                                                <td><?php echo htmlspecialchars($huesped['APELLIDO'], ENT_QUOTES); ?></td>
                                                <td><?php echo htmlspecialchars(date('d/m/Y', strtotime($huesped['FECHANACIMIENTO'])), ENT_QUOTES); ?></td>
                                                <td><?php echo htmlspecialchars($huesped['DIRECCION'], ENT_QUOTES); ?></td>
                                                <td><?php echo htmlspecialchars($huesped['TELEFONO'], ENT_QUOTES); ?></td>
                                                <td><?php echo htmlspecialchars($huesped['EMAIL'], ENT_QUOTES); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
