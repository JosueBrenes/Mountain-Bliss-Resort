  ...
  <div class="content">
    ...
    <section class="options_area">
      <div class="container">
        ...
        <h1 style="color: #333">Agregar Nuevo Huésped</h1>
                <form action="insertar_huesped.php" method="POST">
                    ...
                    <button type="submit" class="btn" style="background-color: #013e6a; color: white; margin-bottom: 2rem;">Agregar Huésped</button>
                </form>
            </div>
        </div>
      </div>
