...
$stid = oci_parse($conn, 'BEGIN obtener_servicios(:p_cursor); END;');
...
<head>
    ...
    <title>Servicios - Mountain Bliss Resort</title>
    ...
    <div class="content">
        ...
        <section class="options_area">
            <div class="container">
                ...
                <a href="funciones/generar_reporte_servicios.php" class="button">Filtrar Servicio por Costo</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th>ID</th>
                    ...
                    <tbody>
                        <?php while (($row = oci_fetch_assoc($cursor)) !== false): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($row['SERVICIOID'], ENT_QUOTES); ?></td>
                                <td><?php echo htmlspecialchars($row['NOMBRESERVICIO'], ENT_QUOTES); ?></td>
